import { s as $n } from "./index-d475d2ea.js";
import { R as Le, r as Te } from "./index-61bf1805.js";
import {
  b as Ei,
  c as Jn,
  d as Ci,
...
import { P as Jr } from "./index-8d47fad6.js";
import { g as Nt, c as lt, a as ns } from "./_commonjsHelpers-de833af9.js";
import { d as ss } from "./index-356e4a49.js";
var as = Ei,
  os = Jn,
  us = Ci,
  ls = "[object Object]",
  ...
  hs = Object.prototype,
  Ai = cs.toString,
  fs = hs.hasOwnProperty,
  ps = Ai.call(Object);
function ds(e) {
  if (!us(e) || as(e) != ls) return !1;
  var t = os(e);
  if (t === null) return !0;
  var r = fs.call(t, "constructor") && t.constructor;
  return typeof r == "function" && r instanceof r && Ai.call(r) == ps;
}
var ms = ds;
const gs = Nt(ms);
var { FRAMEWORK_OPTIONS: Kt } = $n,
  Iu = (e, t) => {
  ...
  Xr = Kt != null && Kt.strictMode ? Te.StrictMode : Te.Fragment;
async function Pu(
  {
    storyContext: e,
    unboundStoryFn: t,
  ...
  let c = Le.createElement(
      ys,
      { showMain: r, showException: i },
      Le.createElement(t, { ...e })
    ),
    f = Xr ? Le.createElement(Xr, null, c) : c;
  return s && Gr(a), await Xn(f, a), () => Gr(a);
}
const vs = [
  "a",
  "abbr",
  ...
  (function t(r) {
    ...
    (S.prototype.traverse = function (x, _) {
      ...
      (S.prototype.replace = function (x, _) {
        var k, B, R, G, q, D, H, ne, ue, ie, Q, xe, Ie;
        function Xe(M) {
          var qe, vt, Be, ee;
          if (M.ref.remove()) {
            for (vt = M.ref.key, ee = M.ref.parent, qe = k.length; qe--; )
              if (((Be = k[qe]), Be.ref && Be.ref.parent === ee)) {
                if (Be.ref.key < vt) break;
                --Be.ref.key;
              }
          }
        }
        for (
          ...
          if (
            ...
            (this.__state === p || q === p) && (Xe(D), (D.node = null)),
            this.__state === c || q === c)
          )
            return xe.root;
          if (
            ...
            for (H = ue.length; (H -= 1) >= 0; )
              if (((Ie = ue[H]), (ie = R[Ie]), !!ie))
                if (Array.isArray(ie)) {
                  for (ne = ie.length; (ne -= 1) >= 0; )
                    if (ie[ne]) {
                      if (v(G, ue[H]))
                        D = new E(ie[ne], [Ie, ne], "Property", new b(ie, ne));
                      else if (C(ie[ne]))
                        D = new E(ie[ne], [Ie, ne], null, new b(ie, ne));
                      else continue;
                      k.push(D);
                    }
                } else C(ie) && k.push(new E(ie, Ie, null, new b(R, Ie)));
          }
        }
        return xe.root;
      });
    ...
    (s.prototype._serializeMappings = function () {
      for (
        ...
        (S += e.encode(C.generatedColumn - c)),
          (c = C.generatedColumn),
          C.source != null &&
            ((I = this._sources.indexOf(C.source)),
            (S += e.encode(I - b)),
            (b = I),
  ...
  (a.fromSourceMap = function (y, g) {
    ...
    (a.prototype.eachMapping = function (g, b, E) {
      ...
      v.map(function (O) {
        ...
        return (
          (L = e.computeSourceURL(I, L, this._sourceMapURL)),
          {
            source: L,
    ...
    (a.prototype.allGeneratedPositionsFor = function (g) {
      ...
      if (C >= 0) {
        ...
        if (g.column === void 0)
          for (var I = v.originalLine; v && v.originalLine === I; )
            S.push({
    ...
    (p.prototype.originalPositionFor = function (g) {
      var b = {
        ...
        E = t.search(b, this._sections, function (C, v) {
          var I = C.generatedLine - v.generatedOffset.generatedLine;
          return I || C.generatedColumn - v.generatedOffset.generatedColumn;
        }),
        S = this._sections[E];
      return S
    ...
    (p.prototype._parseMappings = function (g, b) {
      ...
      for (var E = 0; E < this._sections.length; E++)
        for (
          ...
          var I = C[v],
            O = S.consumer._sources.at(I.source);
          ...
          var L = null;
          I.name &&
            ((L = S.consumer._names.at(I.name)),
            this._names.add(L),
            (L = this._names.indexOf(L)));
          var V = {
            source: O,
            generatedLine:
              I.generatedLine + (S.generatedOffset.generatedLine - 1),
            generatedColumn:
              I.generatedColumn +
              (S.generatedOffset.generatedLine === I.generatedLine
                ? S.generatedOffset.generatedColumn - 1
                : 0),
  ...
  return (
    (a.fromStringWithSourceMap = function (f, p, y) {
      ...
      return (
        p.eachMapping(function (L) {
          if (I !== null)
            if (C < L.generatedLine) O(I, S()), C++, (v = 0);
            else {
              var V = b[E] || "",
        ...
        E < b.length && (I && O(I, S()), g.add(b.splice(E).join(""))),
    ...
    (a.prototype.toStringWithSourceMap = function (f) {
      ...
      return (
        ...
        this.walkSourceContents(function (v, I) {
          y.setSourceContent(v, I);
        }),
        { code: p.code, map: y }
      );
    }),
...
function ks() {
  return (
    si ||
      ((si = 1),
      (nt.SourceMapGenerator = Pi().SourceMapGenerator),
      (nt.SourceMapConsumer = As().SourceMapConsumer),
      (nt.SourceNode = ws().SourceNode)),
    nt
  );
}
const Ts = "escodegen",
  Is = "ECMAScript code generator",
  Ps = "http://github.com/estools/escodegen",
  Ns = "escodegen.js",
  Ls = { esgenerate: "./bin/esgenerate.js", escodegen: "./bin/escodegen.js" },
  Os = ["LICENSE.BSD", "README.md", "bin", "escodegen.js", "package.json"],
  Rs = "2.1.0",
  Fs = { node: ">=6.0" },
  Ms = [
    {
  ...
  Bs = { type: "git", url: "http://github.com/estools/escodegen.git" },
  Ds = { estraverse: "^5.2.0", esutils: "^2.0.2", esprima: "^4.0.1" },
  Vs = { "source-map": "~0.6.1" },
  js = {
    "acorn": "^8.0.4",
    "bluebird": "^3.4.7",
...
`,
    ...
    function bt(n, u) {
      ...
      for (o in u)
        u.hasOwnProperty(o) &&
          ((l = u[o]),
          d(l) ? (d(n[o]) ? bt(n[o], l) : (n[o] = bt({}, l))) : (n[o] = l));
      return n;
    }
    function Fn(n) {
      var u, o, l, d, w;
    ...
    function Mn(n) {
      ...
      if (((o = n.toString()), n.source)) {
        ...
        for (
          l = u[1], o = "", P = !1, F = !1, d = 0, w = n.source.length;
          d < w;
          ++d
        )
    ...
    function Br(n) {
      ...
      for (u = 0, o = n.length; u < o; ++u)
        (l = n[u]), (d += Array.isArray(l) ? Br(l) : l);
      return d;
    }
    function K(n, u) {
      if (!x) return Array.isArray(n) ? Br(n) : n;
      if (u == null) {
    ...
    function Un(n, u) {
      ...
      for (
        ...
        (J = K(pe(o[l].slice(P)))), (o[l] = x ? J.join("") : J);
      return (
        (f = F),
        o.join(`
`)
...
`),
    ...
    function Dr(n, u) {
      var o, l, d, w, T, P, F, J, ce, Ge, Qe, qr, Ur, we;
...
` && (d = ["{"]),
              ...
              var T, P, F, J;
              for (
                J = ee, u & ue && (J |= ie), T = 0, P = n.body.length;
                T < P;
                ++T
              )
                k &&
...
` && (d = ["{"])),
                  ...
                  T > 0 &&
                    ...
                    He(n.body[T - 1].range[1], n.body[T].range[0], d)),
                  T === P - 1 && (J |= Q),
                  ...
                  d.push(F),
                  he(K(F).toString()) ||
                    (k && T < P - 1 && n.body[T + 1].leadingComments) ||
                    d.push(C),
                  k &&
                    T === P - 1 &&
                    (n.body[T].trailingComments ||
                      He(n.body[T].range[1], n.range[1], d));
            }),
            d.push(pe("}")),
            d
          );
                  ...
                  (n.specifiers.length === 0
                    ...
                    : ((o = U(o, "{")),
                      ae(function (w) {
                        var T, P;
                        for (
                          o.push(C), T = 0, P = n.specifiers.length;
                          T < P;
                          ++T
                        )
                          o.push(w),
        ...
        ExpressionStatement: function (n, u) {
          ...
          function T(P) {
            ...
            if (
              P.slice(0, 5) !== "async" ||
              !c.code.isWhiteSpace(P.charCodeAt(5))
            )
              return !1;
            for (
              J = 6, ce = P.length;
              J < ce && c.code.isWhiteSpace(P.charCodeAt(J));
              ++J
            );
                  ...
                  : (o.push(v + "{"),
                    n.specifiers.length - l === 1
                      ...
                      : (ae(function (w) {
                          var T, P;
                          for (
                            o.push(C), T = l, P = n.specifiers.length;
                            T < P;
                            ++T
                          )
                            o.push(w),
            ...
            for (
              w = n.declarations[0],
                A.comment && w.leadingComments
                  ? (o.push(`
`),
                    o.push(pe(P.generateStatement(w, T))))
                  : (o.push(fe()), o.push(P.generateStatement(w, T))),
                l = 1,
              ...
              (w = n.declarations[l]),
                A.comment && w.leadingComments
                  ? (o.push("," + C), o.push(pe(P.generateStatement(w, T))))
                  : (o.push("," + v), o.push(P.generateStatement(w, T)));
          }
          return (
        ...
        SwitchStatement: function (n, u) {
          ...
          if (
            (ae(function () {
              o = [
                "switch" + v + "(",
                P.generateExpression(n.discriminant, r.Sequence, M),
                ")" + v + "{" + C,
              ];
            }),
            n.cases)
          ...
          return (
            ae(function () {
              for (
                n.test
                  ? (o = [
                      U("case", P.generateExpression(n.test, r.Sequence, M)),
                      ":",
                    ])
                  : (o = ["default:"]),
                  d = 0,
                  ...
                  w &&
                    ...
                    ((l = P.maybeBlock(n.consequent[0], ee)),
                    o.push(l),
                    (d = 1)),
                ...
                d === w - 1 && u & Q && (T |= Q),
                  (l = pe(P.generateStatement(n.consequent[d], T))),
                  o.push(l),
              ...
              (o = ["for" + v + "("]),
                n.init
                  ? n.init.type === t.VariableDeclaration
                    ...
                    : (o.push(l.generateExpression(n.init, r.Sequence, Ie)),
                      o.push(";"))
                  : o.push(";"),
                n.test &&
                  (o.push(v),
      ...
      (oe.Expression = {
        ...
        BinaryExpression: function (n, u, o) {
          ...
          return (
            ...
            (w = n.operator === "**" ? T : T + 1),
            T < u && (o |= D),
            (P = this.generateExpression(n.left, d, o)),
            (F = P.toString()),
            F.charCodeAt(F.length - 1) === 47 &&
            c.code.isIdentifierPartES5(n.operator.charCodeAt(0))
              ? (l = [P, fe(), n.operator])
              : (l = U(P, n.operator)),
            (P = this.generateExpression(n.right, w, o)),
            (n.operator === "/" && P.toString().charAt(0) === "/") ||
            (n.operator.slice(-1) === "<" && P.toString().slice(0, 3) === "!--")
              ? (l.push(fe()), l.push(P))
              : (l = U(l, P)),
            n.operator === "in" && !(o & D)
              ? ["(", l, ")"]
        ...
        CallExpression: function (n, u, o) {
          var l, d, w;
          for (
            l = [this.generateExpression(n.callee, r.Call, Xe)],
              n.optional && l.push("?."),
              l.push("("),
              d = 0,
        ...
        NewExpression: function (n, u, o) {
          ...
          if (
            ...
            (P = o & ne && !I && d === 0 ? Be : qe),
            (l = U("new", this.generateExpression(n.callee, r.New, P))),
            !(o & ne) || I || d > 0)
          ) {
        ...
        MemberExpression: function (n, u, o) {
          var l, d;
          return (
            (l = [this.generateExpression(n.object, r.Call, o & H ? Xe : qe)]),
            n.computed
              ? (n.optional && l.push("?."),
                l.push("["),
                l.push(
            ...
            v === ""
              ...
              : ((l = [n.operator]),
                n.operator.length > 2
                  ? (l = U(l, d))
                  : ((T = K(l).toString()),
                    (P = T.charCodeAt(T.length - 1)),
                    (w = d.toString().charCodeAt(0)),
                    (((P === 43 || P === 45) && P === w) ||
                      (c.code.isIdentifierPartES5(P) &&
                        c.code.isIdentifierPartES5(w))) &&
                      l.push(fe()),
                    l.push(d))),
            le(l, r.Unary, u)
        ...
        ObjectPattern: function (n, u, o) {
          ...
          if (((T = !1), n.properties.length === 1))
            ...
            for (d = 0, w = n.properties.length; d < w; ++d)
              if (
                ((P = n.properties[d]), P.type === t.Property && !P.shorthand)
              ) {
                T = !0;
                break;
              }
          return (
            ...
            ae(function (J) {
              var ce, Ge;
              for (ce = 0, Ge = n.properties.length; ce < Ge; ++ce)
                l.push(T ? J : ""),
                  l.push(F.generateExpression(n.properties[ce], r.Sequence, M)),
                  ce + 1 < Ge && l.push("," + (T ? C : v));
            }),
            ...
            n.blocks &&
              ae(function () {
                for (d = 0, w = n.blocks.length; d < w; ++d)
                  (T = P.generateExpression(n.blocks[d], r.Sequence, M)),
          ...
          return (
            n.left.type === t.VariableDeclaration
              ? (l = [
                  n.left.kind,
                  fe(),
                  this.generateStatement(n.left.declarations[0], xt),
                ])
        ...
        TaggedTemplateExpression: function (n, u, o) {
          ...
          var d = [
            ...
            this.generateExpression(n.quasi, r.Primary, vt),
          ];
      ...
      (oe.prototype.generateExpression = function (n, u, o) {
        ...
        return (
          ...
          A.verbatim && n.hasOwnProperty(A.verbatim)
            ? Gn(n, u)
            : ((l = this[d](n, u, o)), A.comment && (l = Dr(n, l)), K(l, n))
        );
      }),
...
` &&
    ...
    function Wn(n, u) {
      ...
      return (
        ...
        (A = u),
        x &&
          (e.browser ? (s = lt.sourceMap.SourceNode) : (s = ks().SourceNode)),
        (l = zn(n)),
        x
...
var ar = {
  ...
  zs = {
    "5": or,
    "5module": or + " export import",
    "6": or + " const class extends export import super",
  },
  Ws = /^in(stanceof)?$/,
  yr =
...
function We(e, t) {
  return e < 48
    ...
    ? !0
    : e <= 65535
    ? e >= 170 && Js.test(String.fromCharCode(e))
    : t === !1
    ? !1
    : lr(e, Li) || lr(e, Xs);
}
...
function Ys(e) {
  var t = {};
  for (var r in wt) t[r] = e && Ot(e, r) ? e[r] : wt[r];
  if (
  ...
  return ai(t.onComment) && (t.onComment = Ks(t, t.onComment)), t;
}
function Ks(e, t) {
  return function (r, i, s, a, c, f) {
    var p = { type: r ? "Block" : "Line", value: i, start: s, end: a };
    e.locations && (p.loc = new dt(this, c, f)),
...
var oi = 0,
  ...
  re = function (t, r, i) {
    (this.options = t = Ys(t)),
      ...
      (this.keywords = ze(
        zs[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]
      ));
    var s = "";
    if (t.allowReserved !== !0) {
      for (var a = t.ecmaVersion; !(s = ar[a]); a--);
      t.sourceType === "module" && (s += " await");
    }
    this.reservedWords = ze(s);
    var c = (s ? s + " " : "") + ar.strict;
    (this.reservedWordsStrict = ze(c)),
      (this.reservedWordsStrictBind = ze(c + " " + ar.strictBind)),
      (this.input = String(r)),
      (this.containsEsc = !1),
      i
        ? ((this.pos = i),
  ...
  if (
    ...
    if ((this.next(), this.eat(h.parenL))) {
      ...
      this.enterScope(r ? Bi : 0),
        this.checkLVal(t.param, r ? qi : Oe),
...
z.parseLabeledStatement = function (e, t, r, i) {
...
z.parseVarId = function (e, t) {
  (e.id = this.parseBindingAtom()),
    this.checkLVal(e.id, t === "var" ? _r : Oe, !1);
};
var ot = 1,
  cr = 2,
  Gi = 4;
z.parseFunction = function (e, t, r, i) {
  this.initFunction(e),
  ...
  return (
    ...
    this.enterScope(Sr(e.async, e.generator)),
...
z.parseClassMethod = function (e, t, r, i) {
  return (
...
z.parseImport = function (e) {
  return (
    this.next(),
    this.type === h.string
      ? ((e.specifiers = ta), (e.source = this.parseExprAtom()))
    ...
    case "Identifier":
      t === Oe &&
        ...
        r &&
          ...
          (r[e.name] = !0)),
        t !== oi && t !== Ui && this.declareName(e.name, t, e.start);
      break;
    case "ChainExpression":
      this.raiseRecoverable(
        e.start,
...
var W = re.prototype;
W.checkPropClash = function (e, t, r) {
  if (
...
W.parseMaybeAssign = function (e, t, r) {
...
W.parseExprOp = function (e, t, r, i, s) {
...
W.buildBinary = function (e, t, r, i, s, a) {
...
W.parseMaybeUnary = function (e, t) {
  var r = this.start,
    i = this.startLoc,
    s;
  if (
...
W.parseSubscripts = function (e, t, r, i) {
  for (
    var s =
        this.options.ecmaVersion >= 8 &&
        e.type === "Identifier" &&
...
W.parseSubscript = function (e, t, r, i, s, a) {
...
W.parseParenArrowList = function (e, t, r) {
...
W.parsePropertyValue = function (e, t, r, i, s, a, c, f) {
  if (
...
W.parseMethod = function (e, t, r) {
  ...
  return (
    ...
    (this.awaitPos = 0),
    (this.awaitIdentPos = 0),
    this.enterScope(Sr(t, i.generator) | Di | (r ? Vi : 0)),
    this.expect(h.parenL),
...
W.parseArrowExpression = function (e, t, r) {
  var i = this.yieldPos,
    s = this.awaitPos,
    a = this.awaitIdentPos;
  return (
    this.enterScope(Sr(r, !1) | Mi),
    this.initFunction(e),
...
W.parseFunctionBody = function (e, t, r) {
...
W.checkParams = function (e, t) {
  for (var r = {}, i = 0, s = e.params; i < s.length; i += 1) {
    var a = s[i];
    this.checkLVal(a, _r, t ? null : r);
  }
};
W.parseExprList = function (e, t, r, i) {
...
je.enterScope = function (e) {
  this.scopeStack.push(new ia(e));
};
je.exitScope = function () {
  this.scopeStack.pop();
};
je.treatFunctionsAsVarInScope = function (e) {
  return e.flags & mt || (!this.inModule && e.flags & ct);
};
...
je.currentVarScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    ...
    if (t.flags & br) return t;
  }
};
je.currentThisScope = function () {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & br && !(t.flags & Mi)) return t;
  }
};
var Ft = function (t, r, i) {
    (this.type = ""),
      (this.start = r),
      (this.end = 0),
      t.options.locations && (this.loc = new dt(t, i)),
...
function Cr(e) {
  var t = (Hi[e] = {
    binary: ze(sa[e] + " " + ui),
    nonBinary: { General_Category: ze(ui), Script: ze(oa[e]) },
  });
...
j.regexp_eatRegExpIdentifierStart = function (e) {
  ...
  return (
    ...
    i === 92 &&
      ...
      (i = e.lastIntValue),
    ua(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function ua(e) {
...
j.regexp_eatRegExpIdentifierPart = function (e) {
  ...
  return (
    ...
    i === 92 &&
      this.regexp_eatRegExpUnicodeEscapeSequence(e, r) &&
      (i = e.lastIntValue),
    la(i) ? ((e.lastIntValue = i), !0) : ((e.pos = t), !1)
  );
};
function la(e) {
...
j.regexp_eatUnicodePropertyName = function (e) {
  ...
  for (e.lastStringValue = ""; Ki((t = e.current())); )
    (e.lastStringValue += Tt(t)), e.advance();
...
var Vt = function (t) {
    (this.type = t.type),
      ...
      (this.start = t.start),
      (this.end = t.end),
      t.options.locations && (this.loc = new dt(t, t.startLoc, t.endLoc)),
...
$.skipBlockComment = function () {
  ...
  if (
    ...
    Ye.lastIndex = t;
    for (var i; (i = Ye.exec(this.input)) && i.index < this.pos; )
  ...
  e: for (; this.pos < this.input.length; ) {
    ...
    switch (e) {
      ...
      case 47:
        ...
        break;
      default:
        if ((e > 8 && e < 14) || (e >= 5760 && vr.test(String.fromCharCode(e))))
          ++this.pos;
        else break e;
    }
  }
...
$.getTokenFromCode = function (e) {
  ...
  this.raise(this.pos, "Unexpected character '" + Ar(e) + "'");
};
...
$.readNumber = function (e) {
  ...
  r && /[89]/.test(this.input.slice(t, this.pos)) && (r = !1),
    ...
    Re(this.fullCharCodeAtPos()) &&
      this.raise(this.pos, "Identifier directly after number");
  var a = pa(this.input.slice(t, this.pos), r);
  ...
  function a(p) {
    ...
    if (!y) {
      const g = p.tokTypes,
        ...
        C = new b("</tag", !1),
        v = new b("<tag>...</tag>", !0, !0),
        I = { tc_oTag: S, tc_cTag: C, tc_expr: v },
        O = {
...
var _a = Ei,
  ...
  Aa = "[object String]";
function wa(e) {
  return typeof e == "string" || (!Ea(e) && Ca(e) && _a(e) == Aa);
}
var ka = wa;
const Ta = Nt(ka);
/*!
  ...
  return ci(e) === !1
    ...
    : ((t = e.constructor),
      t === void 0
        ? !0
        : ((r = t.prototype),
          !(ci(r) === !1 || r.hasOwnProperty("isPrototypeOf") === !1)));
}
var un = {},
  It =
    (lt && lt.__assign) ||
      ...
      p
        .map(function (g, b) {
          var E = p.length - 1 === b ? a.newLine : "," + a.newLineOrSpace,
            ...
            v = S || C ? g : At(g, s),
            I = At(e[g], s, r + s.indent);
          return (
            s.transform && (I = s.transform(e, g, I)),
            a.indent + String(v) + ": " + I + E
          );
        })
        .join("") +
      a.pad +
 ...
 */ var kr = Symbol.for("react.element"),
  ...
  Fa = Symbol.for("react.server_context"),
...
var hn = function (t) {
  ...
  Ir = function e(t, r) {
    ...
    if (typeof t == "number") return Ua(t);
    ...
    var p = pi(t.type.defaultProps || {}, fi),
      y = Le.Children.toArray(t.props.children)
        .filter(Xa)
        .map(function (g) {
          return e(g, r);
        });
    return Wa && t.type === Te.Fragment ? za(f, y) : Ga(a, c, p, y);
  };
function Ha() {}
var Qa = function (t) {
    return t
...
`.concat(Ne(r + 1, i.tabStop), "$1")
  ...
  Za = function (t, r, i, s) {
    ...
    if (typeof t == "string") return '"'.concat(Ka(t), '"');
    if (ht(t) === "symbol") {
      var a = t
        .valueOf()
        .toString()
    ...
    return typeof t == "function"
      ? "{".concat(pn(t, s), "}")
      : Te.isValidElement(t)
      ? "{".concat(Qt(Ir(t, s), !0, i, s), "}")
      : t instanceof Date
      ? isNaN(t.valueOf())
        ? "{new Date(NaN)}"
        : '{new Date("'.concat(t.toISOString(), '")}')
      : Ia(t) || Array.isArray(t)
      ? "{".concat(Ya(t, r, i, s), "}")
      : "{".concat(String(t), "}");
  },
  eo = function (e, t, r, i, s, a, c, f) {
    if (!t && !i)
      throw new Error(
        'The prop "'.concat(
          e,
...
`),
  ...
  Qt = function (e, t, r, i) {
    ...
    if (e.type === "string")
      return e.value ? "".concat(vo(yo(String(e.value)))) : "";
    if (e.type === "ReactElement") return mn(e, t, r, i);
    if (e.type === "ReactFragment") return po(e, t, r, i);
...
var pr = "custom",
  ...
  rt = "element";
function Nr(e) {
  return bs.includes(e.toLowerCase());
}
var gn = { format: { indent: { style: "  " }, semicolons: !1 } },
  ko = { ...gn, format: { newline: "" } },
  To = { ...gn };
function De(e, t = !1) {
  return wi.generate(e, t ? ko : To);
}
function dr(e, t = !1) {
  return t ? Io(e) : De(e);
}
...
var yn = (e) => e.$$typeof === Symbol.for("react.memo"),
  Lo = (e) => e.$$typeof === Symbol.for("react.forward_ref"),
  Lr = { ...N, JSXElement: () => {} },
  Oo = re.extend(ba());
function yt(e) {
...
function Ro(e) {
  return { inferredType: { type: "Identifier", identifier: yt(e) }, ast: e };
}
function Fo(e) {
...
function Sn(e, t) {
  ...
  switch (s) {
    ...
    case "Object": {
      let { depth: p } = r;
      (a = gt), (c = p === 1 ? Pt(i, !0) : null), (f = Pt(i));
      break;
    }
    case "Element": {
      let { identifier: p } = r;
      (a = p != null && !Nr(p) ? p : rt),
        (c = vi(e).length === 1 ? e : null),
        (f = e);
      break;
    }
    case "Array": {
      let { depth: p } = r;
      (a = Pr), (c = p <= 2 ? xi(i, !0) : null), (f = xi(i));
      break;
    }
    default:
      (a = zo(s)), (c = vi(e).length === 1 ? e : null), (f = e);
      break;
  }
...
function $o(e) {
  ...
  return t != null && (t.params != null || t.returns != null)
    ? de({
        name: "func",
        short: Co(t.params, t.returns),
        compact: null,
        full: Eo(t.params, t.returns),
      })
    : de({ name: "func", short: Ze, compact: Ze });
}
function Jo(e, t) {
  let r = Object.keys(e.value)
      .map((c) => `${c}: ${et(e.value[c], t).full}`)
      .join(", "),
...
function Xo(e, t) {
  let { short: r, compact: i, full: s } = et(e.value, t);
  return de({
    name: "objectOf",
    short: ur(r),
    compact: i != null ? ur(i) : null,
    full: s && ur(s),
  });
}
function Ho(e, t) {
  if (Array.isArray(e.value)) {
    let r = e.value.reduce(
      (i, s) => {
        let { short: a, compact: c, full: f } = et(s, t);
...
function Qo({ value: e, computed: t }) {
  return t
    ? Sn(e, "enumvalue")
...
function Yo(e) {
  if (Array.isArray(e.value)) {
    let t = e.value.reduce(
      (r, i) => {
        let { short: s, compact: a, full: c } = Qo(i);
...
function Ko(e, t) {
  ...
  if (r === "custom") {
    if (c === "Object") return Si(i, s, a);
  } else if (r === "shape") return Si(i, s, a);
...
function Zo(e) {
  ...
  try {
    switch (t.name) {
      ...
      case "enum":
      case "arrayOf": {
        let { short: r, compact: i, full: s } = et(t, e);
        return i != null && !is(i) ? te(i) : s ? te(r, s) : te(r);
      }
      case "func": {
        let { short: r, full: i } = et(t, e),
          s = r,
          a;
        return i && i.length < Go ? (s = i) : i && (a = Ao(i)), te(s, a);
      }
      default:
        return null;
    }
...
function eu({ inferredType: e, ast: t }) {
  let { identifier: r } = e;
  if (r != null) return te(Cn(e), De(t));
  let i = De(t, !0);
  return ft(i) ? te(Ze, De(t)) : te(i);
}
function tu(e, t) {
...
var nu = (e) => {
    if (wn(e) && e.type != null) return iu(e);
    if (gs(e)) {
  ...
  au = (e) => te(e.toString()),
  Tn = { string: ru, object: nu, function: su, default: au };
function ou(e = {}) {
  return { ...Tn, ...e };
}
function In(e, t, r = Tn) {
  try {
    switch (typeof e) {
      case "string":
        return r.string(e, t);
...
function fu(e, t) {
  let r = t.defaultProps != null ? t.defaultProps : {},
    i = e.map((s) => hu(s, r[s.propDef.name]));
  return uu(i, t);
}
function pu(e, t) {
  let { propDef: r } = e,
...
Object.keys(Jr).forEach((e) => {
  let t = Jr[e];
  _i.set(t, e), _i.set(t.isRequired, e);
});
function mu(e, t) {
  let r = e;
  !ts(e) && !e.propTypes && yn(e) && (r = e.type);
  let i = rs(r, t);
...
var vu = (e, t) => {
    if (typeof e > "u")
      return Ct.warn("Too many skip or undefined component"), null;
    let r = e,
      i = r.type;
    for (let a = 0; a < t.skip; a += 1) {
      if (typeof r > "u") return Ct.warn("Cannot skip undefined element"), null;
      if (Le.Children.count(r) > 1)
        return Ct.warn("Trying to skip an array of elements"), null;
    ...
    return Le.Children.map(e, (a) => {
      let c = typeof a == "number" ? a.toString() : a,
        f = (typeof ut == "function" ? ut : ut.default)(gr(c), s);
      if (f.indexOf("&quot;") > -1) {
        let p = f.match(/\S+=\\"([^"]*)\\"/g);
        p &&
          p.forEach((y) => {
...
`
  ...
  xu = { skip: 0, showFunctions: !1, enableBeautify: !0, showDefaultProps: !1 },
  bu = (e) => {
    var i;
    let t =
  ...
  Pn = (e) => {
    ...
    let { mdxType: t, originalType: r, children: i, ...s } = e.props,
      a = [];
    return (
      i && (a = (Array.isArray(i) ? i : [i]).map(Pn)),
      Te.createElement(r, s, ...a)
    );
  },
  Nn = (e, t) => {
    var g, b;
    ...
    let a = e();
    if (i) return a;
    let c = { ...xu, ...((t == null ? void 0 : t.parameters.jsx) || {}) },
      f =
        (b =
  ...
  Ru = { renderer: "react", ..._u };
export {
  Ou as applyDecorators,
  Lu as argTypesEnhancers,
  Nu as decorators,
  Ru as parameters,
  Iu as render,
  Pu as renderToCanvas,
};
//# sourceMappingURL=config-5699cf5c.js.map
