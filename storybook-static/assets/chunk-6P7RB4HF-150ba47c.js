import { r as Q, $ as D } from "./index-61bf1805.js";
import { s as X } from "./index-d475d2ea.js";
function $() {
  return (
    ($ = Object.assign
      ? Object.assign.bind()
...
var Z = function (t) {
  ...
  N = D["useInsertionEffect"] ? D["useInsertionEffect"] : !1,
  Qe = N || Z,
  Xe = N || Q.useLayoutEffect;
const { logger: V } = __STORYBOOK_MODULE_CLIENT_LOGGER__;
    ...
    if ((t && typeof t == "object") || typeof t == "function")
      for (let n of G(t))
        !ae.call(e, n) &&
          ...
          L(e, n, {
            get: () => t[n],
            enumerable: !(a = te(t, n)) || a.enumerable,
          });
    return e;
  },
  Ve = (e, t, r) => (
...
function R(e) {
  ...
  return (
    (R = function (r) {
      ...
      function a() {
        return x(r, arguments, B(this).constructor);
      }
      return (
...
var l = (function (e) {
  ...
  function t(r) {
    for (
      ...
      o[i - 1] = arguments[i];
    return (
      (a = e.call(this, ue.apply(void 0, [fe[r]].concat(o))) || this), oe(a)
    );
  }
  return t;
})(R(Error));
...
function C(e) {
  ...
  if (i) {
    var p = parseInt("" + i[1], 10),
      f = parseInt("" + i[2], 10) / 100,
      u = parseInt("" + i[3], 10) / 100,
      g = "rgb(" + y(p, f, u) + ")",
      b = j.exec(g);
    if (!b) throw new l(4, t, g);
    return {
      red: parseInt("" + b[1], 10),
  ...
  var d = ve.exec(t.substring(0, 50));
  if (d) {
    var I = parseInt("" + d[1], 10),
      J = parseInt("" + d[2], 10) / 100,
      K = parseInt("" + d[3], 10) / 100,
      M = "rgb(" + y(I, J, K) + ")",
      F = j.exec(M);
    if (!F) throw new l(4, t, M);
    return {
      red: parseInt("" + F[1], 10),
...
function Fe(e) {
  ...
  return (
    (p *= 60),
    e.alpha !== void 0
      ? { hue: p, saturation: u, lightness: i, alpha: e.alpha }
      : { hue: p, saturation: u, lightness: i }
  );
}
function W(e) {
  return Fe(C(e));
...
function Ce(e, t, r, a) {
  if (
    ...
    return a >= 1 ? w(e, t, r) : "rgba(" + y(e, t, r) + "," + a + ")";
  if (typeof e == "object" && t === void 0 && r === void 0 && a === void 0)
    return e.alpha >= 1
      ? w(e.hue, e.saturation, e.lightness)
      : "rgba(" + y(e.hue, e.saturation, e.lightness) + "," + e.alpha + ")";
  throw new l(2);
}
function z(e, t, r) {
  if (typeof e == "number" && typeof t == "number" && typeof r == "number")
    return _("#" + c(e) + c(t) + c(r));
  if (typeof e == "object" && t === void 0 && r === void 0)
    return _("#" + c(e.red) + c(e.green) + c(e.blue));
  throw new l(6);
}
function v(e, t, r, a) {
...
function Y(e) {
  if (typeof e != "object") throw new l(8);
  if (ke(e)) return v(e);
  if (Pe(e)) return z(e);
  if (Oe(e)) return Ce(e);
  if (Ie(e)) return Se(e);
...
function je(e, t) {
  ...
  var r = W(t);
  return Y(m({}, r, { lightness: k(0, 1, r.lightness - parseFloat(e)) }));
}
var Ee = P(je),
  Te = Ee;
function Be(e, t) {
...
function ze(e, t) {
  ...
  var r = C(t),
    ...
    n = m({}, r, { alpha: k(0, 1, (a * 100 + parseFloat(e) * 100) / 100) });
  return v(n);
}
var Me = P(ze),
  et = Me;
