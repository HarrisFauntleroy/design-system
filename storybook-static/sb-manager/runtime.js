...
async function c(t2, e2) {
  ...
  let {
    ...
    A3 = ((await (r3.isElement == null ? void 0 : r3.isElement(b3))) &&
      (await (r3.getScale == null ? void 0 : r3.getScale(b3)))) || {
      x: 1,
      y: 1,
    },
    R3 = s(
...
var g = (n3) => ({
    ...
    async fn(i3) {
      ...
      return {
        [w3]: x3[w3] - W2,
        data: { [w3]: V2, centerOffset: M2 - V2 + W2 },
      };
    },
  }),
  ...
  let a3 = t(n3),
    ...
    c3 =
      l3 === "x"
        ...
        : "top";
  return (
    i3.reference[s3] > i3.floating[s3] && (c3 = y(c3)),
    { main: c3, cross: y(c3) }
  );
}
      ...
      async fn(e2) {
        ...
        switch (o3) {
          case "referenceHidden": {
            ...
            return {
              data: { referenceHiddenOffsets: t3, referenceHidden: P(t3) },
            };
          }
          case "escaped": {
    ...
    return (
      e2 === void 0 && (e2 = {}),
      {
        ...
        async fn(i3) {
          ...
          return w3 !== L3.width || v3 !== L3.height
            ? { reset: { rects: !0 } }
            : {};
        },
      }
